...
if __name__ == '__main__':
    ...
    parser.add_argument('--dev', default="/home/student/keys/marvel.priv", help='Provide the /path/to/file.priv containing Marvel private developer key')
    parser.add_argument('--pub', default="/home/student/keys/marvel.pub", help='Provide the /path/to/file.pub containing Marvel public developer key')

    ## This allows us to pass the lookup character
    parser.add_argument('--hero', default="Rogue", help='Character to search for within the Marvel universe')
