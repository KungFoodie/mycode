...
def task1(name):
    ...
    print(f"Task {name} assigned to thread: {threading.current_thread().name} ")
    print(f"ID of process running task {name}: {os.getpid()}")
...
def main():
    ...
    t2 = threading.Thread(target=task1, name='t2', args="2")   
